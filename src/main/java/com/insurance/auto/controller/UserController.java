...
import com.insurance.auto.model.Makeext;
...
public class UserController {
	...
	public Object getvehicleModel(@PathVariable("Make") String make, @PathVariable("Year") String year){
		...
		Makeext makeext = resttemplate1.getForObject("https://vpic.nhtsa.dot.gov/api/vehicles/getmodelsformakeyear/make/" 
		+ make + "/modelyear/" + year +"?format=json", Makeext.class);
		return makeext;
	}
}
